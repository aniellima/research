...
```
  ...
  + Agora vamos criar um shapfile que tenha apenas as bordas externas da região de interesse:
...
* Ao reescrever o arquivo, é exibida uma mensagem apontando que os caractheres não puderam ser convertidos de UTF-8 para ISO-8859-1. Quando carregamos ao carregar um dos shapphiles, verificamos que os caracteres chineses foram perdidos no processo. conforme exemplo abaixo 
...
* Felizmente o nosso identificador unico 'dt_adcode' é numerico e distinto para cada observacao. O que significa que podemos ignorar essa mensagem por hora já que podemos recuperar os carecteres chinese juntando nossa base com o shapfile original, caso seja necessário.
